  ...
  const options = [
    {
      icon: MessageCircle,
      text: "Tirar Dúvidas",
      href: "https://api.whatsapp.com/send?phone=5535997379861&text=Ol%C3%A1%21%20Tenho%20algumas%20d%C3%BAvidas%20sobre%20o%20ebook%20sobre%20parentalidade%20no%20autismo.",
      isExternal: true
    },
    {
      icon: FileCheck,
